...
function showHelp() {
  alert(`Game Objective: Survive falling exothreats for 60 seconds!\nCollect power-ups to boost your traits and survive.\n\n💊 = Health Pack (+30% health)\n🧪 = Mutation Serum (3-turn immunity and genome boost)\n☢️ = Radiation Hazard\n🔥 = Heat Wave\n💨 = Oxygen Collapse\n🌪️ = Wind Blast\n💀 = Critical Hazard\n\nAvoid hazards, boost genome, and stay alive!`);
}
function endGame() {
  if (!gameRunning) return;
  gameRunning = false;
...
document.body.innerHTML = `
  <div id="gameContainer">
    <button onclick="showHelp()" style='position: absolute; top: 10px; right: 10px; font-family: monospace;'>❓ Help</button>
    <button onclick="saveAndExit()" style='position: absolute; top: 10px; left: 10px; font-family: monospace;'>🔚 Exit</button>
